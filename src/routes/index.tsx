...
import { ArrowRight, BookOpen, BrainCircuit, CheckCircle2, GraduationCap, Lightbulb, Sparkles, Trophy } from "lucide-react";
...
const PILLARS = [
  ...
  { icon: BrainCircuit, title: "Heureca AI", text: "IA + RAG para recuperar contexto, criar aulas, gerar práticas e explorar novos caminhos." },
  { icon: BookOpen, title: "Central acadêmica", text: "Orientação para TCC, portfólio, artigo, monografia, tese, resumos e apresentações." },
  { icon: Trophy, title: "Preparação", text: "Reforço, reciclagem, ENEM, vestibulares e concursos com foco, método e resultado." },
];
